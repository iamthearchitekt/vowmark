  ...
  if (!mounted) {
    return (
      <div className="h-14 bg-vow-paper border-b border-vow-border px-6 flex items-center justify-between text-xs font-sans">
        <span className="text-stone-400">Loading Studio Modes...</span>
      </div>
    );
  }
      ...
      <div className="h-14 bg-vow-paper border-b border-vow-border px-6 flex items-center justify-between text-xs font-sans select-none z-30">
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="flex items-center space-x-1 bg-stone-100 p-1 rounded-lg border border-stone-200">
            <span className="text-[10px] font-mono text-stone-500 font-bold px-1.5 uppercase flex items-center gap-1">
            ...
            {[100, 150, 200].map((z) => (
              <button
                ...
                className={`px-1.5 py-0.5 text-[10px] font-mono rounded font-bold transition-colors cursor-pointer ${
                  zoomLevel === z ? "bg-vow-dark text-white" : "hover:bg-stone-200 text-stone-600"
                }`}
              >
                {z}%
              </button>
